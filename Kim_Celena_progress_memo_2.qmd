...
Through the IMDb website, IMDb registered users can submit a rating (from 1 to 10) on every released movie title in the database. As can be seen in the table, the movie distribution company with the highest overall mean IMDb rating is Trafalgar Releasing.
