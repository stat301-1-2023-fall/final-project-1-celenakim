...
A Metacritic "Metascore" is curated from a weighted average of critic reviews from a scale of 1-100. This graph represents the change in the average Metacritic critic ratings for Hollywood movies for each year from 2007-2022. Like the previous Rotten Tomatoes critic rating plot, this data also seems to have followed the trend of critic ratings generally increasing from 2007 to 2022, but this increase is less dramatic with it being only 20%. Also, both the Rotten Tomatoes critic and Metacritic rating plots seem to follow similar trends of increase, decrease, and peaks, such as ratings increasing significantly from 2009-2012, and dropping significantly from 2019-2020.

### Exploration 4: How do the overall movie budgets change over the years from 2007-2022?
![](figures/yearly_movie_budget_plot.png)
Based on this graph, the average yearly movie budgets seem to fluctuate from 2007-2022. However, as compared to the graph in exploration 1 of yearly average opening weekend earnings, the trends seem to be roughly similar to eachother-- for example, with the highest points for both graphs being around the year 2012 and 2013, and both having a significant drop in the year 2020. This finding could suggest that there could be a correlation between a movie's budget and opening weekend earnings.
...
- What variables affect a movie's opening weekend earnings? 
- What variables affect a movie's Oscar win count?
- How do critic ratings affect various variables of success?
...
How does domestic compare to foreign ?
