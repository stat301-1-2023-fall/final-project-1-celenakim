...
![](figures/genre_opening_success_mean.png) As shown in the table, the "sci-fi & fantasy" genre combination had the most success in terms of highest opening weekend earnings, with about 248 million dollars in earnings.

#### Exploration 2: Which genre has the highest Oscar wins?

![](figures/genre_oscar_counts_table.png) In terms of Oscar win success, the "biography & history" genre was the most successful as this genre combination earned the most amount of Oscars: 4.

#### Exploration 3: Which script type has the highest mean opening weekend earning?

![](figures/script_type_opening_success_table.png) The script type combination that had the most successful opening weekend is "sequel & adaptation", with a mean opening weekend earning of about 84 million.

#### Exploration 4: Which script type has the highest Oscar wins?

![](figures/script_type_oscar_counts_table.png) The script type that earned the most Oscars is "original screenplay", with 28 Oscar wins.

#### Exploration 5: Do movies that have won Oscars have better Rotten Tomatoes critic ratings?

![](figures/rt_rating_oscar_table.png) The table shows that movies that have won an Oscar have a much higher average Rotten Tomatoes critic rating than those who have not won an Oscar (89 vs. 54).

#### Exploration 6: How do the different critic ratings correlate with opening weekend success?

![](figures/rt_critic_success_cor_plot.png) ![](figures/rt_audience_success_cor_plot.png) ![](figures/mc_critic_success_cor_plot.png) ![](figures/mc_audience_success_cor_plot.png) Comparing the line of best fits between the four graphs, the "Rotten Tomatoes Audience Rating" has the steepest increasing line of best fit, and thus the highest positive correlation with "Opening Weekened Earnings (millions)". The relationship is strongest between these two variables and could suggest that movies with a higher Rotten Tomates Audience Rating tend to be more successful in their opening weekend earnings, on average. However, this does not imply causation.

#### Exploration 7: Which distributor has the highest IMDb rating?

![](figures/imdb_rating_by_distr_table.png) Through the IMDb website, IMDb registered users can submit a rating (from 1 to 10) on every released movie title in the database. As can be seen in the table, the movie distribution company with the highest overall mean IMDb rating is Trafalgar Releasing, with a mean IMDb rating of 8.6/10.
