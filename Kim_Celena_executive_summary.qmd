...
According to the plot above, there seems to be an overall positive correlation between a movie's rating and its domestic gross earnings. As the rating of a movie increases, for both audience and critic ratings, its domestic gross revenue also increases. However, comparing across the two rating groups, this correlation seems to be stronger/steeper for audience rating groups than critic rating groups, suggesting that as audience ratings increases, the domestic gross earnings increases at a higher rate than it would with critic ratings. By comparing across the different genres, the "action" genre has the steepest correlation for both plots. This suggests that for movies categorized as “action”, as their movie rating increases, the amount of domestic gross revenue earned for this type of category is greater than other movie genres. This is an example of the one of the may positive correlations found between variables in the graph, with some others being budget and mean opening weekend revenue, domestic gross and foreign gross, etc. The existence of numerous positive correlations between variables highlights the fact that many significant connections exist between movie success factors, and furthermore, exploring such correlations by categorical variables such as genre deepens those analyses even more.

### Conclusion

In all, these three key findings are just some of the many significant takeaways discovered in the report that ultimately answer the questions of what factors contribute to a movie’s overall succes rate, what relationships exist between such variables, and what the ideal conditions of such variables are in order to render a movie to be a hit. Movie success is a multifaceted concept that can be defined by various creative means, from high opening weekend revenue to Oscar wins, and is influenced by a variety of factors such as economic atmospheres and time of the year. Exploring a wide range of such variables and other determinants that may impact a movie’s performance ultimately serves to provide a comprehensive understanding of the film industry and its span of famed blockbusters and unnoticed flops.
